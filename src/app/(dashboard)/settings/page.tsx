      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 md:p-8">
            {message && <div className="mb-4 text-sm text-amber-400">{message}</div>}
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-4 border-t border-slate-700">
                    <button onClick={handleSave} disabled={saving} className="bg-amber-600 hover:bg-amber-500 text-white px-6 py-2.5 rounded-lg font-medium transition-colors disabled:opacity-60">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input type="password" className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-amber-500 transition-colors" />
                  </div>
                  <div>
